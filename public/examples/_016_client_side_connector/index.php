...
$r = new Restler();
$r->setSupportedFormats("Luracast\\Restler\\Format\\JsonFormat", "Luracast\\Restler\\Format\\JsFormat");

// comment the line above and uncomment the line below for production mode
// $r = new Restler(true);

$r->addAPIClass('improved\\Authors');
$r->addAPIClass('improved\\Complex');
$r->addAPIClass('Luracast\\Restler\\ClientSideConnector\\ClientSideConnector');
